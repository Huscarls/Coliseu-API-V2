...
async function getAllCombats() {
  const query = `SELECT cbt.id id, cl1.abbreviation clanAbbreviation1, cl2.abbreviation clanAbbreviation2, swp1.id id_swp1, swp2.id id_swp2, swp1.nickname nickname1, swp2.nickname nickname2, wp1.name wpName1, wp2.name wpName2, cbt.rounds_scored1 roundsScored1, cbt.rounds_scored2 roundsScored2 FROM ${TABLE.combat} cbt
